...
<div class="h-screen w-[300px] bg-white z-20 shadow-xl">
  ...
  <div class="pt-2">
    <img
      ...
      class="w-[130px] h-[130px] rounded-full mx-auto"
      alt=""
    />
  </div>
  ...
  {#if name === "Loading..."}
    <span
      class="loading loading-dots loading-md w-[25px] py-8 bg-blue-900 text-black block mx-auto"
    ></span>
  {:else}
    <h1 class="text-black font-semibold text-[25px] text-center pt-2">
      {name}
    </h1>
    <h1 class="text-black font-semibold text-[15px] text-center pb-2 pt-0">
      {dept}
    </h1>
  {/if}
  ...
  <ul class="justify-end">
    <li class="pt-4 text-center">
      <button
        class="h-[40px] rounded-[10px] hover:bg-slate-800 text-white hover:scale-95 btn-wide bg-slate-900"
        on:click={gotoDashboard}>DASHBOARD</button
      >
    </li>
    <li class="pt-3 text-center">
      <button
        class="h-[40px] rounded-[10px] hover:bg-slate-800 text-white hover:scale-95 btn-wide bg-slate-900"
        on:click={gotoRequests}>REQUESTS</button
      >
    </li>
    <li class="pt-3 text-center">
      <button
        class="h-[40px] rounded-[10px] hover:bg-slate-800 text-white hover:scale-95 btn-wide bg-slate-900"
        on:click={gotoHistory}>HISTORY</button
      >
    </li>
